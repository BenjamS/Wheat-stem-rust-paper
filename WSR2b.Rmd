...
Wheat stem rust, a highly virulent fungal disease once thought to be eradicated from the planet, reemerged in Uganda in 1999 and has been spreading steadily ever since. Wheat experts warn that the disease could pose a catastrophic threat to the global wheat supply if left unchecked. Published assessments of the potential impacts of the disease vary widely in method and results, and generally focus on wheat production alone, without considering how markets may offset or aggravate impacts (spillover effects). Here we take an integrated assessment approach combining biophysical modeling with a global agricultural multi-market equilibrium model to account for direct and indirect economic and food security impacts of wheat stem rust in 8 major geographical regions over the years 2025-2050. The severity and frequency of outbreaks is introduced into the biophysical model based on a survey of 11 international wheat experts. To model the spatial distribution of outbreaks over time, we develop a simple contagion model parameterized based on the airborne spore transmission literature and the expert survey. The results suggest that global market incentives may largely offset the adverse effects of wheat stem rust in most outbreak areas via international trade. However, the market mechanism simultaneously precipitates considerable food insecurity in areas where experts expect little or no wheat stem rust, as farms in these areas reallocate resources from the domestic non-wheat market to the export wheat market, in response to price signals.
...
Wheat stem rust, a fungal disease once thought to be eradicated by the development of resistant wheat varieties during the Green Revolution, has reemerged as a major threat to global food security. The fungus that causes Wheat Stem Rust, _Puccinia graminis_, spreads primarily by emitting spores that are then carried aloft by winds and deposited in a new area, potentially up to thousands of kilometers away---enough to cross oceans. The first new lineage of _P. graminis_ was detected in Uganda in 1999; and several races of this lineage have since spread by aerial transport to much of the rest of the wheat growing world. In such areas, the incidence and severity of Wheat Stem Rust is mitigated only by the research and development of newly resistant wheat varieties, combined with proactive management (spraying of fungicides, in particular). The failure to develop and adequately apply such countermeasures in areas where _P. graminis_ is present has generally resulted in disastrous yield losses.

In order to "right-size" Wheat Stem Rust research---i.e. to provide effective, targeted, timely funding that is proportionate to the threat---it is important to quantify the cost of inaction on this front. Existing assessments of this cost omit the role that market incentives and economic agency play in offsetting and/or aggravating the purely biophysical impacts of the disease. In other words, these assessments effectively imply the "dumb farmer scenario", wherein farmers are assumed to continue stubbornly forward with an unprofitable activity in the face of clear incentives to switch to more lucrative options available to them.

In the real world, the production shortfalls caused by wheat stem rust outbreaks generate price signals that induce farmers in directly affected areas to reallocate land and resources to alternative crops not susceptible to the disease, while also inducing farmers in unaffected areas to reallocate land and resources to wheat for export to the affected areas. In directly affected areas, then, the market mechanism in some measure offsets domestic wheat calorie shortfalls---partly by wheat imports from unaffected areas, and partly by domestic reallocation of cropland and resources to alternative calorie sources. The economic damages to wheat producers in directly affected areas are likewise offset, in some measure, by the elevated price received by wheat producers in unaffected areas. At the same time, however, the reallocation of resources from the domestic to the export market in unaffected areas may, in some measure, precipitate food insecurity far from the occurrence of any outbreak.
<!-- Simply put, surprising things happen with the spatial distribution of impacts when the economic dimension is taken into account. Godfray et al. find that some of worst damages greatest in ...an area where no rice grown. -->
  
Assessments omitting treatment of this rather complex dance of price signals and economic agency are thus prone either to understate or to overstate wheat stem rust induced damages, depending on how the precise quantities hiding behind the phrase "in some measure" balance out. Perhaps more importantly, such studies are limited to spatially aggregate statements, with little capacity to comment on how impacts, both direct and indirect, might vary across regions.
<!-- The question of right-sizing Wheat Stem Rust research funding is as much a question of "where?" as it is a question of "how much"? -->
  
In the present work, we take an integrated assessment modeling approach combining climatic, biophysical, and economic dimensions of analysis to quantify the phrase "in some measure" in a spatially explicit manner. The severity and frequency of wheat stem rust yield shocks are introduced into the biophysical modeling based on a survey of 11 international wheat experts. To provide a plausible schedule of where and when future outbreaks occur, we develop a simple interregional disease spread model inspired by the wheat stem rust aerial transport literature. Based on this ensemble, we present best and worst case projections of the economic and food security impacts of Wheat Stem Rust from 2025 to 2050, disaggregated by eight regions: North Africa & West Asia, Africa South of the Sahara, Russia & Central Asia, South Asia, East Asia & Pacific, Latin America & the Caribbean, North America, and Europe.

To our knowledge, only one other study has taken a comparable multimarket approach to pathogen impact assessment. Godfray et al. [-@godfray2016food] assess the possible economic impacts of a fungal epidemic affecting rice in Southeast Asia for a single year. Methodologically, we go beyond that study by considering impacts over a multi-year time horizon. Our geographical scope is also necessarily much broader, since modern races of Wheat Stem Rust are now affecting nearly every part of the globe.

[brief summary of results here – basically, international trade offsets the WSR impact in directly affected areas, but also precipitates food insecurity in areas not directly affected by WSR, especially South Asia]
...
In this way, it is thought that the TKTTF outbreak in Ethiopia, just mentioned above, originally spread from Yemen [@meyer2017large]; and that _P. graminis_ may occasionally cross the Indian Ocean from Southern Africa to Australia [@visser2019microsatellite; @prank2019climate], as well as the North Atlantic Ocean from Europe to North America [@radici2022early]. Prior to the reemergence of WSR as a global threat, Nagarajan and Singh [-@nagarajan1990long] documented numerous aerial transmission pathways of fungi of the genus _Puccinia_ in general, including transatlantic transmission from Africa to South America, and two routes to Europe from North Africa and West Asia.
...
As mentioned in the Introduction, these studies consider only the biophysical WSR yield shock, without then considering how farmers, as rational economic agents, might respond to the shock through management decisions. An example of a different kind of study that explicitly accounts for markets and economic agency is found in Godfray et al.'s impact assessment of a hypothetical fungal disease affecting rice in Southeast Asia for a single year [-@godfray2016food]. The study by Godfray et al. also controls for the effects of climate change and population/economic growth. Such modeling ensembles are sometimes referred to as integrated assessment models (IAMs). Here we take a IAM approach to assess WSR impacts on supply, demand, and food security in wheat and other key agricultural commodity markets. Methodologically, we go beyond the framework implemented by Godfray et al. by considering impacts over a multi-year period, from 2025 to 2050.
<!-- To address this gap, the present study explicitly models the economic response to the potential global spread of WSR. By accounting for markets, the study accounts for the freedom of farmers to offset agroclimatic adversity by investing more land and inputs in production, or by switching to alternative crops. Such decisions, made in response to price signals, may be profitable and succeed in offsetting agroclimatic adversity at the farm level to some degree, but may also result in aggregate production shortfalls at the country or region scale. They may also incur spillover effects in other commodity markets, as land and resources are drawn away from the production of those commodities in order to confront the WSR threat. -->
...
In the present effort, we attempted to run modeling scenarios accounting for both WSR and the potential war induced shocks suggested in the USDA January 2023 Wheat Outlook. This resulted   in market disequilibria, which equilibrium models like the one used here are not designed to handle; and so we cannot report on such scenarios within the scope of the present study. Nonetheless, this result is instructive in and of itself, as it suggests that the war in Ukraine, combined with global WSR outbreaks, could throw the global supply and demand of wheat, and perhaps of other key staple commodities, into disequilibrium.

[To be updated at time of submission.]

# Method

## The IMPACT model

In order to model the dynamic interplay of climatic, biophysical, and economic forces, we use the International Model for Policy Analysis of Agricultural Commodities and Trade (IMPACT), developed and maintained at the International Food Policy Research Institute [@robinson2015international]. Briefly, IMPACT is comprised of a climate module, a biophysical crop modeling module, and a global multimarket equilibrium module, which altogether cover 62 agricultural commodity markets in 159 countries. Assumptions regarding future population growth, economic growth, and the pace of climate change enter the model as exogenous trends. A more detailed description of IMPACT is given in the Appendix.

Yield shocks are introduced in the biophysical wheat model to represent WSR outbreaks. The location, severity, and frequency of outbreaks is based on a survey of 11 international wheat experts contacted for this study. The consultation was conducted by means of a questionnaire sent to experts within the Alliance of Bioversity and CIAT's extended network of partners over the period April-September of 2021. Respondents specifically covered Canada, Uruguay, Paraguay, Ethiopia, South Africa, and the Central/West Asia and North Africa region. Responses were then synthesized and extrapolated to geographical areas not specifically covered by the survey with help from David Hodson, Director of the Global Wheat Rust Monitoring System. The results of the consultation, which ultimately covered 65 countries, is summarized in Table 1.

```{r, echo=FALSE}
library(flextable)
thisFolder <- "D:/OneDrive - CGIAR/Documents 1/CIAT 2/FnM Initiative/WSR 2Blades/"
thisFile <- "WSR impact expert summary table_ydShock.csv"
...
footText1 <- paste(c("East Africa", paste(eAfr_vec, collapse = ", ")), collapse = " = ")
footText2 <- paste(c("Southern & Eastern Mediterranean basin", paste(SEmedBasinVec, collapse = ", ")), collapse = " = ")
footText3 <- paste(c("Southern Africa", paste(sAfr_vec, collapse = ", ")), collapse = " = ")
footText4 <- paste(c("Central Asia", paste(cAsiaVec, collapse = ", ")), collapse = " = ")
...
thisFile <- "WSR impact expert summary table_outbreakInterval.csv"
thisFilePath <- paste0(thisFolder, thisFile)
dfTab <- read.csv(thisFilePath, stringsAsFactors = F)
dfTab$X <- NULL
colnames(dfTab) <- dfTab[1, ]
dfTab <- dfTab[-1, ]
...
```
The outbreak frequencies gathered from the expert consultation are necessary but insufficient to determine the spatial distribution of outbreaks at a given time. The airborne spore transport studies cited in the previous section suggest that outbreaks in one area are correlated with outbreaks in neighboring areas. Based on these findings, we develop a simple network model to determine a plausible spatial distribution of outbreaks over time. The model calculates outbreak vulnerability in each of the eight focal regions at a given time as a function both of the region's own intrinsic vulnerability and of outbreak vulnerability in neighboring regions. Intrinsic vulnerability is parameterized on the basis of the outbreak frequencies elicited from experts, while the influence of vulnerability in neighboring regions is parameterized on the basis of the cited airborne transport literature. A detailed presentation of this model is given in the Appendix.
<!-- In order to model this complex, dynamic, global interplay of agroclimatic and economic forces, the International Model for Policy Analysis of Agricultural Commodities and Trade (IMPACT) is used. IMPACT, , is not a single model, but rather a suite of models organized into three modules: a crop modeling module, a climate change module, and a multimarket equilibrium module covering more than 60 agricultural commodities. Yield is thus modeled as a function of both agroclimatic and economic factors. This means that exogenous impacts on biophysical factors (as a result of climate change or disease outbreak, for example) can be offset by the farmer's ability to adapt to the biophysical stress of climate change by altering input levels or switching to alternative crops, in response to price signals. Future exogenous yield gains due to ongoing improvements in germplasm and farm management are also taken into account. -->
...
Using this integrated modeling approach, the potential global economic impacts of WSR are modeled from 2025 to 2050. A "no wheat stem rust" counterfactual scenario (No-WSR) is also modeled as a baseline for comparison. The future impacts of WSR on supply, demand, and food security indicators are presented and discussed below in terms of the difference between the WSR and No-WSR magnitudes.
<!-- Both the WSR and No-WSR scenarios take account of climate change, as well as assumptions regarding future GDP growth, technological advances, and demographic trends (the "Shared Socioeconomic Pathway").  -->
<!-- (Figure ). -->
...
<!-- The potential spread, severity, and frequency of future WSR outbreaks was assessed based on consultations with 11 international wheat experts.  -->
...
<!-- For the purposes of modeling, the country level yield loss in the high risk WSR areas is 10-20%, in moderate: 5-10, in low: 0-5.  -->
...
[synthesis/contextualization of results into key message:]

WSR impact assessments have so far focused on specific impact dimensions---biophysical, climatic, economic, geographic spread---in an isolated, piecemeal fashion. Here we have attempted to integrate these dimensions into a single modeling framework.
...
Best and worst case WSR outbreak scenarios were based on expected WSR yield shocks elicited from 11 international wheat experts. The IMPACT model was then used to compute the global economic repercussions of these exogenous shocks in terms of supply, demand, and food security indicators over the period 2025-2050.

Geographic spread...
We used this approach as a quick method for simulating spore atmospheric transfer without resorting to more detailed models that simulate exactly these air movements. The approach served as an example to explore the feasibility of introducing spore movement dynamics into a global economic model. While the approach provides some insights on the sequence of WSR resurgences across regions, it does so at an aggregate level, for big world regions. To obtain a finer level of detail, a natural extension of this work would be to use more explicit atmospheric models, like one proposed by (REF!!!).

Economically, ... under assumptions of GDP and population growth... 
One novel aspect of the present exercise, compared to previous economic impact studies of WSR, is the assessment of spillover effects across commodity markets and geographies. The results of this assessment suggest that future WSR induced grain shortfalls may not be limited to wheat, but extend to other staple commodities, especially other cereals. In addition to the cumulative wheat production shortfall, then, the present analysis projects a cumulative non-wheat cereal production shortfall of `r prodWLDocer2033B*5/1000`-`r prodWLDocer2033W*5/1000` million metric tons, relative to the No-WSR baseline, by 2050.
(also climatically)

Summary of findings...
...this works out to a cumulative wheat production shortfall of `r prodWLDwhea2033B*5/1000`-`r prodWLDwhea2033W*5/1000` million metric tons, relative to the No-WSR baseline, by 2050. The present analysis thus suggests that WSR induced wheat production shortfalls may be considerably more severe than the picture painted by Savary et al. [-@savary2019global], but somewhat less severe than the shortfalls estimated by Pardey et al. [-@pardey2013right].
...
We have relied on expert opinion to quantify potential yield losses to WSR in the future and in different regions. By so doing, we have not explicitly considered the impact of climate change on crop growth and yield under WSR stress. While previous research can provide information on the risk of WSR infection at different scales (e.g., Prank et al., 2019 ) using such findings into integrated assessment models like IMPACT requires translating infection risks into productivity shocks. Combined crop-disease models that can potentially cover this requirement are still under development (Donatelli et al., 2017 ).

Given that WSR is prevalent in almost all wheat growing regions (???, #REF), the yield shocks provided by experts reflect their (subjective) opinion on the additional loss incurred by the disease should it re-emerge. Implicit in this estimate is farmers’ response to the disease, which we assume to be constant over time. This means that we do not consider possible improvements in plant health protection that may be achieved either through new chemical products, or simply from the overall improvement of farmer managerial capacity over time. Although this may be a strong assumption, Savary et al. (2019) report that the overall level of crop health has not changed substantially from 2003 to 2017. We draw on this finding to further assume that farmer managerial capacity will also remain unchanged during the time frame of the analysis. Future research could explore the possibility to incorporate additional assumptions and scenarios for the level of plant health management without causing a dimensionality problem that would render the analysis intractable. 

Tightly linked to the issue of plant health management is that of the spatial heterogeneity of the WSR outbreaks and its overall impacts. Because we adopt a macro-view of the WSR problem, the local specificities and the various factors that may affect disease dynamics at subnational levels are not explicitly captured. On the contrary, it is assumed that the spatial heterogeneity is implicit in the aggregate representation of the agricultural sector provide by IMPACT. Taking a closer look at this heterogeneity is a different research question altogether that requires micro-level tools. 



Other pathogens affecting wheat and other crops are omitted, whereas the study by Savary et al. (2019) identifies dozens of pathogens likely to afflict wheat and other key crops in the coming decades. This assumption is driven by convenience and by pure luck of information about the potential impact of CC, and other drivers, on various crops and pathogens. This paper is among the first attempts to assess the impacts of a crop disease worldwide. As such, one of the objectives is to identify potential problems that may arise during such synthesis. These problems will need to be addressed to also incorporate information from crop-disease models that will become available in the future, and to align the overall modeling approach with integrated frameworks that have already been developed by AgMIP and other international modeling groups.
the equilibrium model assumes that markets react to WSR outbreaks instantaneously, whereas in reality there would generally be a lag of at least one cropping season between news of an outbreak and reallocation of farmland in response to price signals. 

This is a fundamental problem of equilibrium models like IMPACT used herein, since their fundamental assumption is annual market clearing. We acknowledge that a market disequilibrium is likely to occur in the short term if many world regions are subject to yield shocks simultaneously, which means that equilibrium models may not always be the best tool to simulate such shocks in commodity supply (Godfray et al., 2016). As an example of this argument, we attempted to introduce constraints related to the RUS-UKR war by decreasing the supply of wheat and maize from UKR. Notwithstanding the uncertainty around the duration of these shocks (which require additional scenarios, thereby increasing/exacerbating the dimensionality problem), we were not able to solve the model. Given the price making role of UKR for the cereal market, this result reveals the market disequilibrium caused by the war, which has led to continuous deal-brokering attempts to resume grain exports from the country.
...
## A more detailed description of the IMPACT model

This is meant as a quick reference offering a more detailed, but not exhaustive, explanation of the IMPACT model than is offered in the main text. For the exhaustive treatment, see the model documentation [@robinson2015international].

In IMPACT, assumptions regarding future climate change are captured in the assumed Representative Concentration Pathway (RCP). The chosen RCP determines future carbon concentration and radiative forcing, which in turn drives future temperature increases. For the present study, RCP 6.0 is assumed, which projects a mean global temperature rise of 0.8-1.8 degrees Celsius by 2050 over the 2005 level. Future climate is then modeled by feeding this RCP into the Hadley Centre’s Global Environment Model, version 2 (HADGEM2-ES). The climate is then downscaled to subnational spatial resolution and fed into crop models (DSSAT) to determine the biophysical yield.

Economic yields are then calculated at the country level as a function of the biophysical yield, producer input and output prices, and an exogenous yield growth factor representing improvements in technology and management. The yield growth factor (or "intrinsic productivity growth rate") is extrapolated from the historical yield growth trend in corroboration with expert consultation, and may be interpreted as a continuation of the status quo level of improvement, absent major positive or negative departures from the historical trend.

Country level production of a given commodity is then calculated as the economic yield times the harvested area, where area is calculated as a function of commodity price, population growth, and land availability. Farmers are thus assumed to adjust both land allocation and economic yield in response to price signals. Domestic demand for agricultural commodities is calculated as a function of population and GDP, based on Engel's law. Given supply (domestic production + imports - exports) and demand, the multi-market agricultural sector equilibrium model in IMPACT then solves for the next year's market clearing commodity prices at both the domestic and international level. Starting yields and areas are taken from FAOSTAT.

Because commodity demand and supply are partly functions of future population and GDP growth, assumptions regarding these exogenous trends must be specified before running IMPACT. In Integrated Assessment Modeling, such assumptions are typically bundled together in narratives called Shared Socioeconomic Pathways (SSP). In the present study, SSP2 is assumed. The model documentation describes this as "a middle of the road scenario that follows historical trends. Economic development continues but is not uniform. Environmental degradation continues but at a slowing pace.... Climate change presents moderate challenges to both adaptation and mitigation". For full details see Robinson et al. [-@robinson2015international].
<!-- technology advancement, and intergovernmental action (or inaction) on climate change, -->
<!-- SSP3 is assumed. This is a pessimistic scenario "characterized by increasing nationalism with greater levels of conflict and challenges to global and regional cooperation. Barriers to trade increase, and countries tend to look inward at the expense of global cooperation. There are lower levels of technological change. Economic development is slow, and population growth is higher. Climate change presents significant challenges for both adaptation and mitigation" -->
<!-- RCP 8.5 is assumed, which projects a mean global temperature rise of 1.4-2.6 degrees Celsius by 2050 over the 2005 level -->
<!-- (www.metoffice.gov.uk/research/modelling-systems/unified-model/climate-models/hadgem2) -->
<!-- . These models are each fed the same set of assumptions regarding future carbon concentration and radiative forcing (i.e., the same RCP). The WSR best and worst case scenarios, as well as the No-WSR baseline scenario, were modeled using each of the four GCMs, generating 12 scenarios total. Results were then averaged over the GCMs, leaving the three scenarios examined in the analysis below (WSR best case, WSR worst case, and the No-WSR baseline). -->

## Dynamic modeling of the spatial distribution of outbreaks

<!-- --- -->
<!--   title: "Draft of the spatial distribution of outbreaks model" -->
