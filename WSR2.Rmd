...
Yield shocks are introduced in the biophysical wheat model to represent WSR outbreaks. The location, severity, and frequency of outbreaks is based on a survey of eleven international wheat experts contacted for this study. The consultation was conducted by means of a questionnaire sent to experts within the Alliance of Bioversity and CIAT's extended network of partners over the period April-September of 2021. Respondents specifically covered Canada, Uruguay, Paraguay, Ethiopia, South Africa, and the Central/West Asia and North Africa region. Responses were then synthesized and extrapolated to geographical areas not specifically covered by the survey with help from David Hodson, Director of the Global Wheat Rust Monitoring System.
<!-- The results of the consultation, which ultimately covered 65 countries, is summarized in Table 1. -->
...
The various components of WSR impacts, climatic, biophysical, economic, aerial spread, ... have been modeled piecemeal. Here we have attempted to integrate these different components into a single modeling framework.
...
Economic yields are then calculated at the country level as a function of the biophysical yield, producer input and output prices, and an exogenous yield growth factor representing improvements in technology and management. The yield growth factor (or "intrinsic productivity growth rate") is extrapolated from the historical yield growth trend in corroboration with expert consultation, and may be interpreted as the status quo level of improvement, absent major positive or negative departures from the historical trend.
